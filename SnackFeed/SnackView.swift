...
//        timeLabel.topAnchor.constraint(equalTo: bottomAnchor, constant: 10).isActive = true
//        timeLabel.heightAnchor.constraint(equalToConstant: 30).isActive = true
//        timeLabel.widthAnchor.constraint(equalToConstant: frame.width - 60).isActive = true
//
...
//        reactionButton.topAnchor.constraint(equalTo: bottomAnchor, constant: 10).isActive = true
